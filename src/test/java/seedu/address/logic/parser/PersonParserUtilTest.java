...
import static seedu.address.logic.parser.PersonParserUtil.MESSAGE_INVALID_INDEX;
...
public class PersonParserUtilTest {
    ...
    public void parseIndex_invalidInput_throwsParseException() {
        assertThrows(ParseException.class, () -> PersonParserUtil.parseIndex("10 a"));
    }

    @Test
    public void parseIndex_outOfRangeInput_throwsParseException() {
        assertThrows(ParseException.class, MESSAGE_INVALID_INDEX, ()
            -> PersonParserUtil.parseIndex(Long.toString(Integer.MAX_VALUE + 1)));
    }

    @Test
    public void parseIndex_validInput_success() throws Exception {
        // No whitespaces
        assertEquals(INDEX_FIRST_OBJECT, PersonParserUtil.parseIndex("1"));
    ...
    public void parseAddress_null_throwsNullPointerException() {
        assertThrows(NullPointerException.class, () -> PersonParserUtil.parseAddress((String) null));
    }

    @Test
    public void parseAddress_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> PersonParserUtil.parseAddress(INVALID_ADDRESS));
    }

    @Test
    public void parseAddress_validValueWithoutWhitespace_returnsAddress() throws Exception {
        Address expectedAddress = new Address(VALID_ADDRESS);
        assertEquals(expectedAddress, PersonParserUtil.parseAddress(VALID_ADDRESS));
    }
    ...
    public void parseAddress_validValueWithWhitespace_returnsTrimmedAddress() throws Exception {
        ...
        Address expectedAddress = new Address(VALID_ADDRESS);
        assertEquals(expectedAddress, PersonParserUtil.parseAddress(addressWithWhitespace));
    }
